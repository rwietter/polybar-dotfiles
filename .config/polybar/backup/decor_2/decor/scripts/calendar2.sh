...
sleep 8
) | dzen2 -fg '#D8DEE9' -bg '#0A0A0A' -fn 'fantasque sans mono:pixelsize=15:antialias=true:hinting=true' -x 960 -y 30 -w 200 -l 10 -h 20 -sa c -e 'onstart=uncollapse;button1=exit;button4=exit'
